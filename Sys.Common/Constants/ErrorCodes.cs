namespace Sys.Common.Constants
{
    public static class ErrorCodes
    {
        ...
        public enum PromotionError
        {
            ...
            GetDataDefinitionStructureByPromotionCodeFailed = 80014,
            GetListPromotionByCustomerCodeShiptoCodeFailed = 80015,
            GetDetailPromotionExternalByCodeFailed = 80016,
            ExternalGetListItemGroupByItemHierarchyFailed = 80017,
            GetPromotionResultFailed = 80018,
            GetListPromotionCodeDapperFailed = 80019,
            GetDataInitialPromotionMainFailed = 80020,
            ExtenalApiCheckBudgetInfoPromotionFailed = 80021,
            GetListPromotionByCustomerFailed = 80022
        }
        ...
        public enum TpDiscountError
        {
            ...
            GetListDiscountByCustomerCodeShiptoCodeFailed = 32019
        }
        ...
        public enum CustomerError
        {
            ...
            GetListCustomerShiptoFailed = 92002,
        }
        #endregion
    }
}