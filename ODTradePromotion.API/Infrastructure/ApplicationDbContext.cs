...
namespace ODTradePromotion.API.Infrastructure
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        #region Temp Table For Trade Promotion
        public virtual DbSet<Temp_TpOrderDetails> Temp_TpOrderDetails { get; set; }
        public virtual DbSet<Temp_TpOrderHeaders> Temp_TpOrderHeaders { get; set; }
        #endregion
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MobileVisitStep>(entity =>
            {
                ...
                entity.Property(e => e.UpdatedDate).HasColumnType("timestamp(6) with time zone");
            });
            ...
            modelBuilder.Entity<PolicyAccessReport>(entity =>
            {
                ...
                entity.Property(e => e.AccessedDate).HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity<PolicyTerritoryLevel>(entity =>
            {
                ...
                entity.Property(e => e.TerritoryStructureCode).HasMaxLength(20);
            ...
            modelBuilder.Entity<PrincipalPullDataQueue>(entity =>
            {
                ...
                entity.Property(e => e.ExcuteDate).HasPrecision(6);

                entity.Property(e => e.Owner).HasMaxLength(255);

                entity.Property(e => e.OwnerId).HasMaxLength(100);

                entity.Property(e => e.OwnerShiptoId).HasMaxLength(100);
            ...
            modelBuilder.Entity<SaleProcessSetting>(entity =>
            {
                ...
                entity.Property(e => e.EffectiveDate).HasColumnType("timestamp(6) with time zone");
                ...
                entity.Property(e => e.ValidUntil).HasColumnType("timestamp(6) with time zone");
            });
