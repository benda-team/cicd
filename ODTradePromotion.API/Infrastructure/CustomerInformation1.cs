...
{
    public partial class CustomerInformation1
    {
        public CustomerInformation1()
        {
            CustomerContacts = new HashSet<CustomerContact>();
            CustomerContract1s = new HashSet<CustomerContract1>();
        ...
        public virtual ICollection<CustomerContract1> CustomerContract1s { get; set; }
